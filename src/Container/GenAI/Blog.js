...
const Blog = () => {
  return (
    <section className="bg-gray-100 relative px-6 pt-16 pb-20 lg:px-8 lg:pt-20 lg:pb-28">
      <div className="absolute inset-0">
        <div className="h-1/3 bg-gray-100 sm:h-2/3"></div>
      </div>
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          <h2 className="text-xl font-bold tracking-tight text-gray-900 lg:text-5xl">
            INSIGHTS
          </h2>
