...
const ArticleCard = ({
  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg shadow-md shadow-blue-shade-2/60">
      <div className="flex-shrink-0">
        <img className="h-48 w-full object-cover" src={imageUrl} alt="" />
      </div>
      <div className="flex flex-1 flex-col justify-between bg-blue-shade-5/70 p-6">
        <div className="flex-1">
          ...
          >
            <p className="text-xl font-semibold text-blue-shade-2">{title}</p>
    ...
    <section className="relative bg-gray-50 px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-blue-shade-2 sm:text-4xl">
            INSIGHTS
          </h2>
