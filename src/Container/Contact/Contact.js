...
const Contact = () => {
  return (
    <div>
      ...
      {/* <section className="bg-white mt-20 mb-20 ">
        <div className="container px-6 py-12 mx-auto">
          <div className="text-center ">
            <p className="font-medium text-5xl text-blue-500 ">CONTACT US</p>

            <h1 className="mt-2 text-3xl font-semibold text-gray-800 md:text-2xl">
      ...
      {/* Form Section */}
      <section
        className="min-h-screen bg-cover mb-0"
        // style={{
        //   backgroundImage:
          ...
          <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
            <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
              <div className="text-black lg:w-1/2 lg:mx-6">
                ...
                <button className="px-8 py-3 mt-6 text-md font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-900 rounded-md hover:bg-gray-500 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-50">
                  get in touch
                </button>
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  <div className="flex mt-4 -mx-1.5 ">
                    ...
                    >
                      <svg
                        className="w-12 h-16 fill-current"
                        viewBox="0 0 24 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6">
                <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl  lg:max-w-xl">
                  ...
                  <form className="mt-6">
                    ...
                    <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-900 rounded-md hover:bg-gray-500 focus:outline-none focus:ring focus:ring-gray-400 focus:ring-opacity-50">
                      get in touch
                    </button>
                  </form>
                </div>
